...
<br />If your browser does not support JavaScript, you\'ll have to switch to a browser that does - AKKAR reccomends <a href="http://www.mozilla.org/products/firefox/" target="_blank">Firefox</a>.</p>
<br /><br /><br /></div>
</noscript>
...
echo '
	...
	<tr>
		...
		<table cellpadding="0" cellspacing="0" class="stjerne-nav">
		<tr>
			<td class="stjerne-tv">&nbsp;</td>
			<td class="stjerne-topp">&nbsp;</td>
			<td class="stjerne-th">&nbsp;</td>
		</tr>
		<tr>
			<td class="stjerne-venstre">&nbsp;</td>
			<td class="stjerne-midt">
';
include('nav.php');
echo '
			</td>
